-- =============================================================================
-- ShopTop / TM SHOP SRL — migrare consolidata "platforma noua" (LOCAL)
-- =============================================================================
...
--
-- Varianta LOCAL: foloseste baza "shoptop".
-- Pentru server ruleaza fisierul migrate-platforma-noua-server.sql.
--
